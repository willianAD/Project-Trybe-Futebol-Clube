# TFC FULL STACK com TypeScript e JavaScript

## Funcionalidades

Este é o projeto Trybe Futebol Clube!

O projeto deve incluir o back-end e front-end funcionando com um banco de dados.
...
A proposta é a criação de uma API que deve ser consumida por um front-end, para tanto, a criação de um docker-compose será de suma importância!
